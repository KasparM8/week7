...
const heroes = ['Harry Potter', 'Luke Skywalker', 'Batman','Cpt. America', 'Peter Griffin' ];
const villains = ['Lord Voldemort', 'Darth Vader', 'Joker', 'Sauron', 'Thanos']
const weapon = ['Lightsaber', 'banana peel', 'flip-flop', 'magic wand', 'M16']
...
launcherBtn.addEventListener('click', () => {
    ...
    heroSpan.innerHTML = `Hero ${randomHero} is armed with a ${randomHeroWeapon}.`;
    villainSpan.innerHTML = `Villain ${randomVillain} is armed with a ${randomVillainWeapon}.`;
